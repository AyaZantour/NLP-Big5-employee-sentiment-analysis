...
with st.sidebar:
    ...
    st.markdown("**Précision:** 65-75%")
    st.markdown("**Classes:** Négatif 😠 | Neutre 😐 | Positif 😊")
    
    st.markdown("---")
    st.markdown("### 📊 Statistiques")
    st.metric("Avis analysés", "10,000+")
    st.metric("Précision modèle", "70%")
    
    st.markdown("---")
    st.info("💡 **Astuce:** Collez un avis Glassdoor pour analyser son sentiment!")
...
with st.expander("📖 Comment fonctionne cette application?"):
    ...
    **Technologies utilisées:**
    ...
    - 🎯 **Fine-tuning**: Entraîné sur 10,000+ avis Glassdoor
